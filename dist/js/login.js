...
//登录功能
//1.获取元素
var txt = document.querySelector('.login-content .user');
var pwd = document.querySelector('.login-content .pass');
var button = document.querySelector('.login-content .login'); //2.从ajax请求数据对比输入的数据，点击登录按钮跳转页面
